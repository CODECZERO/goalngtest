...
func (cfg *apiConfig) handlerCreateFeed(w http.ResponseWriter, r *http.Request, user db.User) {
...
func (cfg *apiConfig) handlerGetFeeds(w http.ResponseWriter, r *http.Request) {
	...
	if err != nil {
		respondWithError(w, http.StatusInternalServerError, "couldn't ger feed")
		return
	}
